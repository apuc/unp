<div class="b-filter-top">
	<div class="b-filter-top__sport-nav">
		<ul class="b-filter-top__sport-main-list">
			<li class="b-filter-top__sport-main-item">
				<a
					...
					class="nav-link <?php echo false === Postparameter::get('sport', false) ? 'active' : ''; ?>"
				>Все</a>
			</li>
			<?php if(!is_null(Postparameter::topical('sport'))): ?>
				<?php if(Postparameter::get('sport', false)): ?>
					<input
						data-ss-pn-parameter="sport"
						type="hidden"
						value="<?php echo e(Postparameter::get('sport')); ?>"
					>
				<?php endif; ?>

				<?php $__currentLoopData = Postparameter::topical('sport')->getParameters()['values']->slice(0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<li class="b-filter-top__sport-main-item">
						<a
							href="javascript: void(0);"
							data-ss-pn-submit="click"
				...
				<?php if(Postparameter::topical('sport')->getParameters()['values']->count() > 3): ?>
					<li class="b-filter-top__sport-main-item b-filter-top__sport-other-button">
						<a class="
							nav-link
							dropdown-toggle
							<?php if(Postparameter::topical('sport')->getParameters()['values']->slice(3)->filter(function ($value) {
						...
						<div class="win-nav b-filter-top__sport-other-pulldown">
							<div class="win-cont">
								<ul>
									<?php $__currentLoopData = Postparameter::topical('sport')->getParameters()['values']->slice(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li class="nav-item">
											<a
												href="javascript: void(0);"
												data-ss-pn-submit="click"
		...
		<?php if(!is_null(Postparameter::topical('day'))): ?>
			<?php if(Postparameter::get('day', false)): ?>
				<input
					data-ss-pn-parameter="day"
					data-ss-filter-input="day"
					type="hidden"
					value="<?php echo e(Postparameter::get('day')); ?>"
				>
			<?php endif; ?>
				...
				<div class="b-calendar__date-picker">
					<div class="b-calendar__button" id="calendar-dates" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
						<span class="b-calendar__icon"></span> <span><?php echo e(call_user_func(function () {
								$day = Postparameter::get('day', now()->format('Y-m-d'));
								return ''
					...
					<div class="b-calendar-dates dropdown-menu" aria-labelledby="calendar-dates">
						<?php $__currentLoopData = Postparameter::topical('day')->getParameters()['values']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div
								data-ss-pn-submit="click"
...
</div><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/partial/site/panel/post/filter.blade.php ENDPATH**/ ?>