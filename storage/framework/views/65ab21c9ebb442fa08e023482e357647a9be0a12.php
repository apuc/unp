<div data-ss-forecasts-offers>
	<div class="form-group row mb-0">
		<label class="col-md-3 col-form-label">Коэффициент <span class="red">*</span></label>
		<div class="col-md-9">
			<div class="bets-box">
				<div class="nav nav-tabs outcometype-tabs">
					<a class="nav-item nav-link" id="outcometype-1-tab" data-toggle="tab" href="#outcometype-1" aria-controls="outcometype-1" aria-selected="true">1X2</a>
				...
				<div class="tab-content outcometype-content mb-0">
					<div class="tab-pane fade" id="outcometype-1" aria-labelledby="outcometype-1-tab">
						<div class="nav nav-tabs outcomescope-tabs">
							<a class="nav-item nav-link" id="outcomescope-1-1-tab" data-toggle="tab" href="#outcomescope-1-1" aria-controls="outcomescope-1-1" aria-selected="true">Осн. время</a>
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="outcomescope-1-1" aria-labelledby="outcomescope-1-1-tab">
					...
					<div class="tab-pane fade" id="outcometype-2" aria-labelledby="outcometype-2-tab">
						<div class="nav nav-tabs outcomescope-tabs">
							<a class="nav-item nav-link" id="outcomescope-2-1-tab" data-toggle="tab" href="#outcomescope-2-1" aria-controls="outcomescope-2-1" aria-selected="true">Осн. время</a>
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="outcomescope-2-1" aria-labelledby="outcomescope-2-1-tab">
								<p class="text-center pb-3 pt-3">Загрузка...</p>
							</div>
					...
					<div class="tab-pane fade" id="outcometype-6" aria-labelledby="outcometype-6-tab">
						<div class="nav nav-tabs outcomescope-tabs">
							<a class="nav-item nav-link" id="outcomescope-6-1-tab" data-toggle="tab" href="#outcomescope-6-1" aria-controls="outcomescope-6-1" aria-selected="true">Осн. время</a>
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="outcomescope-6-1" aria-labelledby="outcomescope-6-1-tab">
								<p class="text-center pb-3 pt-3">Загрузка...</p>
							</div>
					...
					<div class="tab-pane fade" id="outcometype-9" aria-labelledby="outcometype-9-tab">
						<div class="nav nav-tabs outcomescope-tabs">
							<a class="nav-item nav-link" id="outcomescope-9-1-tab" data-toggle="tab" href="#outcomescope-9-1" aria-controls="outcomescope-9-1" aria-selected="true">Осн. время</a>
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="outcomescope-9-1" aria-labelledby="outcomescope-9-1-tab">
								<p class="text-center pb-3 pt-3">Загрузка...</p>
							</div>
					...
					<div class="tab-pane fade" id="outcometype-10" aria-labelledby="outcometype-10-tab">
						<div class="nav nav-tabs outcomescope-tabs">
							<a class="nav-item nav-link" id="outcomescope-10-1-tab" data-toggle="tab" href="#outcomescope-10-1" aria-controls="outcomescope-10-1" aria-selected="true">Осн. время</a>
						...
						<div class="tab-content">
							<div class="tab-pane fade" id="outcomescope-10-1" aria-labelledby="outcomescope-10-1-tab">
								<p class="text-center pb-3 pt-3">Загрузка...</p>
							</div>
					...
					<div id="offers-box" hidden>
						<input type="hidden" name="bookmaker_id" value="">
						<input type="hidden" name="outcome_id" value="">
						<table class="table table-sm bookmaker-table">
							<thead>
								<tr>
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input class="form-control" type="hidden" name="rate" value="">
		</div>
	</div>
</div><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/account/forecast/offers.blade.php ENDPATH**/ ?>