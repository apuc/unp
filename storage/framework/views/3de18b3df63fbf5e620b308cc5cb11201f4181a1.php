<div class="filter-box accordion" id="filter-box">
    ...
    <div class="collapse" id="filter" data-parent="#filter-box">
		...
		<div class="filter-btns">
			<a href="<?php echo e(route('site.match.index')); ?>" class="btn btn-light">Сбросить фильтр</a>
		</div>
    </div>
</div><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/partial/site/sidebar/matches.blade.php ENDPATH**/ ?>