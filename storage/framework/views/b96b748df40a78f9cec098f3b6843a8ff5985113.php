			...
			<table class="table table-sm bets-table">
				<thead>
					<tr>
						...
						<th class="outcomesubtype">1X <span class="active-down"></span></th>
						<th class="outcomesubtype">12 <span class="active-down"></span></th>
						<th class="outcomesubtype">X2 <span class="active-down"></span></th>
					</tr>
					<?php $__currentLoopData = $bookmakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookmaker_id => $bookmaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<tr>
							...
							<td
								...
								data-ss-forecasts-offer-description="1X, <?php echo e($offer['outcometype_name']); ?>, <?php echo e($offer['outcomescope_name']); ?>"
								class="odds"
							>
							...
							<td
								...
								data-ss-forecasts-offer-outcome-id="<?php echo e($offer['outcome_id']); ?>"
								data-ss-forecasts-offer-rate="<?php echo e(is_null($offer['odds_current']) ? '0.00' : sprintf('%0.02f', $offer['odds_current'])); ?>"
								data-ss-forecasts-offer-description="12, <?php echo e($offer['outcometype_name']); ?>, <?php echo e($offer['outcomescope_name']); ?>"
								class="odds"
							>
								<<?php echo e(($offer['has_offers'] ? 'span' : 'strike')); ?>
							...
							<td
								...
								data-ss-forecasts-offer-outcome-id="<?php echo e($offer['outcome_id']); ?>"
								data-ss-forecasts-offer-rate="<?php echo e(is_null($offer['odds_current']) ? '0.00' : sprintf('%0.02f', $offer['odds_current'])); ?>"
								data-ss-forecasts-offer-description="X2, <?php echo e($offer['outcometype_name']); ?>, <?php echo e($offer['outcomescope_name']); ?>"
								class="odds"
							>
								<<?php echo e(($offer['has_offers'] ? 'span' : 'strike')); ?>
...
<?php echo $__env->make('layout.site.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/account/forecast/dc.blade.php ENDPATH**/ ?>