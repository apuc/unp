<?php $__env->startSection('content'); ?>
	<div class="card-wrap account-forecasts-detail">
		...
		<form id="brief-form" action="<?php echo e(route('account.brief.store')); ?>" method="post" enctype="multipart/form-data" onsubmit="return false;">
				...
				<div class="col-md-9">
					<select name="sport_id" class="form-control<?php echo e($errors->has('sport_id') ? ' is-invalid' : ''); ?>" id="sport">
						...
						<?php $__currentLoopData = $sports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sport): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option <?php echo $sport->id == old('sport_id') ? 'selected="selected"' : ''; ?> value="<?php echo e($sport->id); ?>"><?php echo e($sport->name); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.site.grid.double', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/account/brief/create.blade.php ENDPATH**/ ?>