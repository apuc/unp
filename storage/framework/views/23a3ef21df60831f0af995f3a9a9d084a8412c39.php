<div class="card article-card">
	...
	<div class="card-body">
		<a href="<?php echo e(route('site.post.show', ['post' => URI::asSlug($post->id, $post->name)])); ?>" class="card-image-top">
			<img src="<?php echo e(asset('preview/502/300/storage/posts/' . $post->picture)); ?>" alt="<?php echo e($post->name); ?>">
		</a>
...
<?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/card/site/post/home.blade.php ENDPATH**/ ?>