<?php $__env->startSection('content'); ?>
	<div class="card-wrap account-forecasts-detail">
		...
		<form id="post-form" action="<?php echo e(route('account.post.store')); ?>" method="post" enctype="multipart/form-data" onsubmit="return false;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.site.grid.double', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/account/post/create.blade.php ENDPATH**/ ?>