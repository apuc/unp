<?php $__env->startSection('content'); ?>
	<div class="card card-detail forecasts-detail forecasts-detail--<?php echo e($forecast->forecaststatus->slug); ?>" id="description">
		...
		<div class="card-body">
			...
			<div class="forecasts-detail__val">
    			...
    			<div class="forecasts-detail__val-item">
    				Букмекер:
        			<a href="<?php echo e($forecast->bookmaker->site); ?>" class="bookmaker" target="_blank" rel="nofollow">
		...
		<div class="card-footer">
			...
			<div class="card-user">
				...
				<div class="user-img"><a href="<?php echo e(route('site.user.show', ['login' => $forecast->user->login])); ?>"><img src="<?php echo e(asset('preview/33/33/storage/users/' . $forecast->user->avatar)); ?>" alt="<?php echo e($forecast->user->nickname); ?>"></a></div>
			</div>
		</div>
	</div>
	...
	<?php if(!Auth::guest()): ?>
		<div id="your-comment" class="card-wrap">
			...
			<form action="<?php echo e(route('site.forecast.comment', ['forecast' => $forecast->id])); ?>" method="post">
	...
	<?php if($forecast->forecastcomments->count()): ?>
		<div class="card-wrap" id="comment">
			<h2 class="title">КОММЕНТАРИИ <span><?php echo e($forecast->forecastcomments_count); ?></span></h2>

			<?php $__currentLoopData = $forecast->forecastcomments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forecastcomment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php echo $__env->make('card.site.forecastcomment.normal', [
...
<?php $__env->startSection('sidebar'); ?>
	<?php echo $__env->make('partial.site.sidebar.forecast', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>



<?php echo $__env->make('layout.site.grid.double', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/site/forecast/show.blade.php ENDPATH**/ ?>