			...
			<div class="col-xs-12 ml-lg-auto col-lg-6">
				<div class="form-group row">
					<div class="ml-sm-auto col-sm-8">
							...
							&nbsp;
							<button onclick="location.assign('<?php echo e(route('office.tournament.index')); ?>');" type="button" class="btn btn-primary" title="<?php echo app('translator')->get('button.office.reset'); ?>">
...
</script><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/office/tournament/filter.blade.php ENDPATH**/ ?>