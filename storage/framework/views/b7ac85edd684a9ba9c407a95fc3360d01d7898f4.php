<div>
			...
			<div v-if="tournament.is_top == is_top" class="b-matches__tournament-item">
				...
				>
					<div v-if="null !== tournament.logo" class="b-matches__tournament-flag">
						<img :src="'<?php echo e(asset('preview/40/40')); ?>' + tournament.logo">
					</div>
				...
				>
					<a v-for="match in tournament.matches" :href="'<?php echo e(route('site.match.index')); ?>' + '/' + match.id" class="b-matches__match-item">
						...
						<div class="b-matches__match-participant-1">
							<span v-if="null !== match.team1_icon" class="participant-img">
								<img :src="'<?php echo e(asset('preview/20/20')); ?>' + match.team1_icon">
							</span>
							{{ match.team1_name }}
						</div>
						<div class="b-matches__match-participant-2">
							<span v-if="null !== match.team2_icon" class="participant-img">
								<img :src="'<?php echo e(asset('preview/20/20')); ?>' + match.team2_icon">
							</span>
							{{ match.team2_name }}
						</div>
						...
						>
							<div class="b-matches__sport-title">
								<span v-if="null !== sport.icon" class="sport-icon">
									<img :src="'<?php echo e(asset('preview/24/24')); ?>' + sport.icon" :alt="sport.name">
								</span>
								{{ sport.name }}
							</div>
	...
	<!-- END список матчей -->
</div><?php /**PATH /var/www/sportliga/site/sportliga.com/resources/views/page/site/match/load.blade.php ENDPATH**/ ?>